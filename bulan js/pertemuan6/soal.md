...
**Pengumpulan:** kumpulkan di Form submission pada spesifik link folder pertemuan 6 pada repository GitHub nya
...
***
***
### 📌 <span style="font-family: 'Georgia', serif;">*Silahkan isi dengan jawaban jawaban Berdasarkan kemampuan dan pemahaman yang telah anda kuasai saja sejauh ini dan itu bisa di pertanggung jawabakan dan di persoalkan nantinya atas apa yang anda tuliskan pada jawaban jawaban ini*</span>
***
***
...
**Tugas 1:** => "Apa yang kamu dapatkan dan yang kamu pahami secara sejauh ini dalam kelas pemrograman tuliskan secara mendetail dan rinci tanpa ada yang tertinggal sedikitpun dalam benak anda dengan penjelesan yang jelas dan mudah di pahami"
### 📌 <span style="font-family: 'Georgia', serif;">*Code/Fitur/Fungsi/Program/Sistem yang persis mirip semisal sudah pernah di gunakan dalam sesi kelas tidak di anggap sebagai orisinil maka nilai akan mempengaruhi*</span>
...
**Tugas 4:** => "Sekarang saatnya silahkan merapihkan penjelasan pada setiap alur/flow di seluruh code yang sudah anda tulis dari file Practice dan file Experiment secara mendetail mudah di pahami dan rinci tanpa ada yang terlewat sedikitpun penjelasan sintaknya."
### 📌 <span style="font-family: 'Georgia', serif;">*Code/Fitur/Fungsi/Program/Sistem yang persis mirip semisal sudah pernah di gunakan dalam sesi kelas tidak di anggap sebagai orisinil maka nilai akan mempengaruhi*</span>

# <span style="font-family: 'Helvetica', sans-serif;">Evaluation</span>
**Tugas 5:** => "Apa yang anda tidak pahami dari berbagai metode metode sintaks yang sudah kita pelajari sejauh ini coba jelaskan secara mendetail dan gamblang problem yang anda hadapi"
